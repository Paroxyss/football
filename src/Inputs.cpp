...
// cout : 1 entrée
inline void writeVal(Matrix &mat, double v, uint &i, double min,
					 double max) {
	mat.set(i, 0, mmn(v, min, max));
	i++;
}

inline void writeValn(Matrix &mat, double v, uint &i, double min,
					  double max) {
...
/*
	...
	team == true -> droite
*/
void writeInputs(player &viewer, player *equipeAlliee,

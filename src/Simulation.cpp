...
/**
 * @brief Simuler les deux meilleurs joueurs n'est pas toujours le plus
 * cohérent car ils peuvent être très similaires. La fonction permet de
 * simuler un match entre deux individus sélectionnés aléatoirement.
 */
